...
export const TicketReducer = (state = initialState, action) => {
    ...
    switch(action.type) {
        ...
        case UPDATE_TICKET:
          // console.log('UPDATE_TICKET FIRING', action.payload)
          return{
            ...state, 
            ticket: {...state.ticket, category: action.payload.ticket_details.category, title: action.payload.ticket_details.title, 
              description: action.payload.ticket_details.description, open_video_id: action.payload.ticket_details.open_video_id, 
              open_video: action.payload.ticket_details.open_video, },
            openPictures: action.payload.open_pictures,
            resolvedPictures: action.payload.resolved_pictures,
            openVideo: action.payload.open_video,
            resolvedVideo: action.payload.resolved_video,
